...
export const primitiveTokens = {
  ...
  typography: {
    ...
    letterSpacing: {
      ...
      normal: { $value: "0em", $type: "dimension", $description: "Body tracking" },
...
export const semanticTokens = {
  ...
  surface: {
    base: { $value: primitiveTokens.color.slate[50].$value, $type: "color", $description: "Main page background (slate-50)" },
    paper: { $value: primitiveTokens.color.base.white.$value, $type: "color", $description: "Card, modal & paper surface (white)" },
    band: { $value: "rgba(238, 242, 255, 0.6)", $type: "color", $description: "Alternating conversational band (indigo-50/60)" },
  ...
  border: {
    ...
    light: { $value: primitiveTokens.color.indigo[50].$value, $type: "color", $description: "Soft indigo tint border (indigo-50)" },
    accent: { $value: primitiveTokens.color.indigo[200].$value, $type: "color", $description: "Highlighted accent border (indigo-200)" },
    focus: { $value: primitiveTokens.color.indigo[600].$value, $type: "color", $description: "Accessibility focus ring (indigo-600)" },
  },

  // 10% Accents & 3D Depth Elements
  accent: {
    primary: { $value: primitiveTokens.color.indigo[600].$value, $type: "color", $description: "Brand primary accent (indigo-600)" },
    primaryLight: { $value: primitiveTokens.color.indigo[50].$value, $type: "color", $description: "Accent light surface (indigo-50)" },
    primaryHover: { $value: primitiveTokens.color.indigo[700].$value, $type: "color", $description: "Brand primary hover (indigo-700)" },
    gradientTo: { $value: primitiveTokens.color.violet[500].$value, $type: "color", $description: "Accent gradient end (violet-500)" },
    warm: { $value: primitiveTokens.color.amber[500].$value, $type: "color", $description: "Secondary warm accent (amber-500)" },
    blockShadow: { $value: primitiveTokens.color.slate[200].$value, $type: "color", $description: "3D block shadow color (slate-200)" },
    blockShadowIndigo: { $value: primitiveTokens.color.indigo[200].$value, $type: "color", $description: "3D block shadow indigo (indigo-200)" },
    blockShadowDark: { $value: primitiveTokens.color.indigo[300].$value, $type: "color", $description: "3D block shadow active hover (indigo-300)" },
  },

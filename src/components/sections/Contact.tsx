export default function Contact() {
  const socials = [
    {
      name: "Gmail",
      href: "mailto:vucongchien204@gmail.com",
      icon: (
  ...
  return (
    <section id="contact" className="bg-white py-16 sm:py-24">
      ...
      {/* Chat-style input bar — Contact card */}
      <div className="max-w-2xl mx-auto">
        ...
        >
          {/* Placeholder text */}
          <span className="flex-1 text-slate-400 text-sm sm:text-base select-none">
            Say hello...
          </span>
          ...
          <div className="flex items-center gap-1">
            {socials.map((s) => (
              <a
                ...
                title={s.name}
                className="
                  p-2 rounded-full text-slate-400

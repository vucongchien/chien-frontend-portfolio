...
const variants: Record<BadgeVariant, string> = {
  tech: "inline-flex items-center rounded-full bg-slate-100 px-2.5 py-0.5 text-xs font-serif font-medium text-slate-600 border border-slate-200/60 transition-colors duration-200 group-hover:bg-indigo-50 group-hover:text-indigo-700 group-hover:border-indigo-200/60",
  period:
